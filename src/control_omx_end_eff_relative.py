...
class OpenManipulatorControl():
	...
	def __init__(self):
		...
		self.object_pos = np.asarray([0.31, 0.0, 0.02])
		self.action_position_limits = (-0.05, 0.05)

		self.OPEN_GRIPPER_VALUE = [0.01]
		self.CLOSE_GRIPPER_VALUE = [-0.01]
		...
		self.goal_task_space_path_client = rospy.ServiceProxy("/goal_task_space_path_position_only", SetKinematicsPose)
